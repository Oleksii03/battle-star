import{a as w,o as $}from"../assets/cabinet-CYTlPDzu.js";import{u as L,g as y,h as T}from"../assets/header-CdN_4YgH.js";import{g as S,a as k,c as M,S as g,G as j}from"../assets/vendor-tCLRAaZl.js";function O(){document.addEventListener("click",e=>{t(e),s(e)});function t(e){var r;const i=e.target.closest(".header__user-inner-item"),a=e.target.closest(".header__user-item-box");!(i!=null&&i.classList.contains("header__user-inner-item"))&&!(a!=null&&a.classList.contains("header__user-item-box"))&&((r=L)==null||r.classList.remove("header__user-inner-list_open"))}function s(e){var r;const i=e.target.closest(".game-dropdown-item__inner-item"),a=e.target.closest(".js-game-dropdown-box");!(i!=null&&i.classList.contains("game-dropdown-item__inner-item"))&&!(a!=null&&a.classList.contains("js-game-dropdown-box"))&&((r=y)==null||r.classList.remove("game-dropdown-item__inner-list_open"))}}async function m(t){const s=S(w);try{const e=await k(M(s,t)),i=[];return e.forEach(a=>{i.push({id:a.id,...a.data()})}),i}catch(e){return console.error("Error getting documents:",e),[]}}function P(t){const s=document.querySelector(".js-main-slider-news");if(!s)return;const e=t.map(i=>{const{title:a,description:o,views:r,date:n,image:{png:c,webp:l},author:{img:d,name:p}}=i;return`
      <li class="splide__slide">
          ...
          </li>`});s.innerHTML=e.join("")}function D(){m("SliderBattleStarNews").then(s=>P(s))}function x(){setTimeout(()=>{new g(" .main-stage__news-slider",{gap:"30px",grid:{rows:2,cols:3,gap:{row:"30px",col:"30px"}},pagination:!1,breakpoints:{768:{grid:{cols:2},pagination:!0},1919:{arrows:!1}}}).mount({Grid:j})},1e3)}function C(){new g(".main-stochholm__slider",{pagination:!1,breakpoints:{1919:{arrows:!1,pagination:!0}}}).mount()}const h="mainPageListTop",v="mainPageListTopDota",E="mainPageLeaderboardCards",H="mainPagePopularMatchesCardsList",q="mainPagePopularMatches";function A(t,s){if(!t.length){s.innerHTML='<li><p class="list-top__empty">No data available</p></li>';return}const e=[...t].sort((i,a)=>a.score-i.score).map(i=>{const{name:a,score:o,id:r,countryFlagImg:{webp:n},avatar:{png:c,webp:l}}=i;return`
          ...
          </li>`});s.innerHTML=e.join("")}function z(t,s){if(!t.length){s.innerHTML='<li><p class="list-top__empty">No data available</p></li>';return}const e=[...t].sort((i,a)=>a.score-i.score).map(i=>{const{name:a,score:o,id:r,countryFlagImg:{webp:n},avatar:{png:c,webp:l}}=i;return`
           <li class="list-top__item" data-id="${r}">
            <p class="list-top__item-num"></p>
            <picture>
              <source
            ...
            <p class="list-top__name">${a}</p>
            <p class="list-top__score">${o}</p>
          </li>`});s.innerHTML=e.join("")}function u(t=" "){const s=document.querySelector(".js-main-leaderboard-top-list");if(!s){console.error("Leaderboard container not found");return}if(t===h){m(t).then(e=>A(e,s)).catch(e=>console.error("Error fetching CS:GO data:",e));return}if(t===v){m(t).then(e=>z(e,s)).catch(e=>console.error("Error fetching Dota data:",e));return}console.log("Invalid search query")}function I(t){const s=document.querySelector(".js-main-leaderboard-cards-list");if(!t.length){s.innerHTML='<li><p class="list-top__empty">No data available</p></li>';return}const e=t.map(i=>{const{title:a,date:o,description:r,id:n,img:{png:c,webp:l},likes:d,views:p}=i;return`
          ...
          </li>`});s.innerHTML=e.join("")}function N(t=" "){m(t).then(s=>I(s)).catch(s=>console.error("Error fetching data:",s))}function F(){const t=document.querySelector(".js-leaderboard-btn-csgo"),s=document.querySelector(".js-leaderboard-btn-dota"),e=document.querySelector(".js-btns-thumb");t==null||t.addEventListener("click",i);function i(){e==null||e.classList.remove("main-leaderboard__btns-thumb_active"),t==null||t.classList.add("csgo-active"),s==null||s.classList.remove("dota-active"),u(h)}i(),s==null||s.addEventListener("click",a);function a(){e==null||e.classList.add("main-leaderboard__btns-thumb_active"),s==null||s.classList.add("dota-active"),t==null||t.classList.remove("csgo-active"),u(v)}N(E)}function R(t){const s=document.querySelector(".js-main-popular-matches-cards-list"),e=t.map(i=>{const{id:a,roundOf:o,image:{png:r,webp:n},firstTeam:{firstTeamLogo:c,firstTeamTitle:l},secondTeam:{secondTeamLogo:d,secondTeamTitle:p}}=i;return`
        <li class="list-cards__item" data-id="${a}">
          ...
          <div class="list-cards__bottom-content">
            ...
            </li>`});s.innerHTML=e.join("")}function U(t=" "){m(t).then(s=>G(s)).catch(s=>console.error("Error fetching data:",s))}function W(){B(H),U(q)}document.addEventListener("DOMContentLoaded",()=>{T(),O(),D(),x(),F(),C(),W(),$()});
