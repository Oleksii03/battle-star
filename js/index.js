      ...
      <li class="splide__slide">
        ...
        <li class="list-cards__item" data-id="${a}">
          ...
          <div class="list-cards__bottom-content">
            ...
            </li>`});s.innerHTML=e.join("")}function W(t=" "){m(t).then(s=>G(s)).catch(s=>console.error("Error fetching data:",s))}function V(){B(S),W(k)}function J(){return window.location.hostname==="localhost"?"/cabinet":`${K}cabinet`}document.addEventListener("DOMContentLoaded",()=>{M(),H(),C(),A(),F(),z(),V(),$(),j(),console.log(J())});const K=window.location.pathname;
