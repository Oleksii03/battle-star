      ...
      <li class="splide__slide">
        ...
        <li class="list-cards__item" data-id="${a}">
          ...
          <div class="list-cards__bottom-content">
            ...
            </li>`});s.innerHTML=e.join("")}function W(t=" "){m(t).then(s=>G(s)).catch(s=>console.error("Error fetching data:",s))}function V(){U(S),W(k)}document.addEventListener("DOMContentLoaded",()=>{M(),H(),A(),C(),R(),z(),V(),$(),j()});const J=window.location.pathname;console.log(J);
