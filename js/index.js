      ...
      <li class="splide__slide">
        ...
        <li class="list-cards__item" data-id="${a}">
          ...
          <div class="list-cards__bottom-content">
            ...
            </li>`});s.innerHTML=e.join("")}function W(t=" "){m(t).then(s=>U(s)).catch(s=>console.error("Error fetching data:",s))}function V(){G(S),W(k)}document.addEventListener("DOMContentLoaded",()=>{M(),H(),A(),C(),R(),z(),V(),$(),j(),console.log(window.location.pathname)});
