import{b as d,d as g,t as r,e as m,v as l,f as p,u as _}from"./vendor-Cuq87dUK.js";import{b as a}from"./cabinet-CvSio9GG.js";function f(){return`
        ...
        </ul>`}function c(i){const s=i.querySelector(".js-form-input-icon-view");s==null||s.addEventListener("click",()=>{const n=i.querySelector(".js-form-input-password"),e=i.querySelector(".js-icon-line-cross-out");if(n.type==="password"){n.type="text",e.style.display="none";return}n.type="password",e.style.display="inline-block"})}function v(){const i=new d;g(a,i).then(s=>{const n=s.user;console.log("User signed in with Google:",n),window.location.href="/battle-star/cabinet"}).catch(s=>{console.error("Error signing in with Google:",s)})}function h(i){const s=i.querySelector(".js-login-provider-list");s==null||s.addEventListener("click",n=>{const e=n.target.closest("li");if(e!=null&&e.classList.contains("js-form-item-google")){v();return}})}const w={positionClass:"toast-top-right",closeButton:!0,progressBar:!0,timeOut:5e3,extendedTimeOut:1e3};r.options=w;function b(i){i.innerHTML=f(),i.addEventListener("submit",s=>{s.preventDefault();let n=document.querySelector(".js-login-email");if(!n)return;const e=n.value,o=document.querySelector(".js-login-password").value;console.log(e),m(a,e,o).then(t=>{window.location.href="/cabinet",i.reset()}).catch(t=>{console.error("Error signing in:",t),r.error("Не вдалося увійти. Перевірте свій email або пароль і спробуйте ще раз.")})}),h(i),c(i)}function y(){return`
        <div class="sign-in__form-input-box">
          <input
            type="text"
