import{f as d,h as m,J as g,i as p,j as _,k as v}from"./vendor-OwqoIaUp.js";import{h as r,b as a}from"./cabinet-Dwn9lRut.js";function f(){return`
        ...
        </ul>`}function l(i){const e=i.querySelector(".js-form-input-icon-view");e==null||e.addEventListener("click",()=>{const s=i.querySelector(".js-form-input-password"),n=i.querySelector(".js-icon-line-cross-out");if(s.type==="password"){s.type="text",n.style.display="none";return}s.type="password",n.style.display="inline-block"})}function h(){const i=new d;m(a,i).then(e=>{const s=e.user;console.log("User signed in with Google:",s),window.location.href=window.location.hostname==="localhost"?"/cabinet":"/battle-star/cabinet#statistics-dota",localStorage.setItem("logged","true")}).catch(r)}function w(i){const e=i.querySelector(".js-login-provider-list");e==null||e.addEventListener("click",s=>{const n=s.target.closest("li");n!=null&&n.classList.contains("js-form-item-google")&&h()})}function c(i){const e=i.querySelector("#email"),s=i.querySelector("#password"),n=i.querySelector("#name"),t=new g(i);t.addField(e,[{rule:"required",errorMessage:"Email is required."},{rule:"email",errorMessage:"Email is invalid!"}]),t.addField(s,[{rule:"required",errorMessage:"Password is required."},{rule:"password",errorMessage:"Password must be strong."}]),n&&t.addField(n,[{rule:"required",errorMessage:"Name is required."},{rule:"minLength",value:2,errorMessage:"Name must be between 2 and 30 characters."},{rule:"maxLength",value:30,errorMessage:"Name must be between 2 and 30 characters."}])}function b(i){i.innerHTML=f(),i.addEventListener("submit",e=>{e.preventDefault();let s=document.querySelector(".js-login-email");if(!s)return;const n=s.value,t=document.querySelector(".js-login-password").value;p(a,n,t).then(o=>{window.location.href=window.location.hostname==="localhost"?"/cabinet":"/battle-star/cabinet#statistics-dota",localStorage.setItem("logged","true"),i.reset()}).catch(r)}),w(i),l(i),c(i)}function y(){return`
        <div class="sign-in__form-input-box">
          <input
            id="name"
            type="text"
        ...
        <button
          ...
          type="submit">
          Створити
        </button>`}async function j(i,e,s){try{const t=(await _(a,i,e)).user;return await v(t,{displayName:s}),window.location.href=window.location.hostname==="localhost"?"/cabinet":"/battle-star/cabinet#statistics-dota",localStorage.setItem("logged","true"),t}catch(n){r(n)}}function q(i){i.innerHTML=y(),i.addEventListener("submit",e=>{e.preventDefault();let s=document.querySelector(".js-form-input-email");if(!s)return;const n=s.value.trim(),t=document.querySelector(".js-form-input-password").value,o=document.querySelector(".js-input-nickname").value.trim();j(n,t,o).then(u=>{u&&i.reset()}).catch(r)}),l(i),c(i)}function L(){const i=document.querySelector(".js-form-btn-enter"),e=document.querySelector(".js-form-btn-create"),s=document.querySelector(".js-form-btns-tumb"),n=document.querySelector(".js-sign-in-form");i==null||i.addEventListener("click",t);function t(){i==null||i.classList.add("active-btn"),e==null||e.classList.remove("active-btn"),s==null||s.classList.remove("sign-in__form-btns-tumb_active"),n instanceof HTMLFormElement&&b(n)}t(),e==null||e.addEventListener("click",o);function o(){e==null||e.classList.add("active-btn"),i==null||i.classList.remove("active-btn"),s==null||s.classList.add("sign-in__form-btns-tumb_active"),n instanceof HTMLFormElement&&q(n)}}export{L as s};
//# sourceMappingURL=loginOrRegistrationHandler-ineD22De.js.map
