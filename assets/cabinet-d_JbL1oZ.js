import{c as g,d as a,h as p,o as c,l as _}from"./signOut-7ANRpM1j.js";import{b as f,s as v,t as l,d as h,v as u,e as w,u as y}from"./vendor-CHXV-Q4N.js";function b(){if(window.location.pathname.includes(g)){const e=document.querySelector(".js-user-inner-list"),s=document.querySelector(".js-sidebar-btn-exit"),n=document.querySelector(".js-sidebar-btn-enter"),t=document.querySelector(".js-user-active-title"),o=document.querySelector(".js-icon-arrow-down"),r=document.querySelector(".header__user-item");s==null||s.classList.remove("sidebar__nav-item_hidden"),n==null||n.classList.add("sidebar__nav-item_hidden"),t.style.cursor="auto",t&&(t.style.cursor="auto"),e&&(e.style.display="none"),o&&(o.style.display="none"),r&&(r.style.cursor="auto")}}function j(){return`
        ...
        </ul>`}function d(i){const e=i.querySelector(".js-form-input-icon-view");e==null||e.addEventListener("click",()=>{const s=i.querySelector(".js-form-input-password"),n=i.querySelector(".js-icon-line-cross-out");if(s.type==="password"){s.type="text",n.style.display="none";return}s.type="password",n.style.display="inline-block"})}function q(){const i=new f;v(a,i).then(e=>{const s=e.user;console.log("User signed in with Google:",s),window.location.href=m}).catch(e=>{console.error("Error signing in with Google:",e)})}function S(i){const e=i.querySelector(".js-login-provider-list");e==null||e.addEventListener("click",s=>{const n=s.target.closest("li");if(n!=null&&n.classList.contains("js-form-item-google")){q();return}})}const L={positionClass:"toast-top-right",closeButton:!0,progressBar:!0,timeOut:5e3,extendedTimeOut:1e3};l.options=L;function k(i){i.innerHTML=j(),i.addEventListener("submit",e=>{e.preventDefault();let s=document.querySelector(".js-login-email");if(!s)return;const n=s.value,t=document.querySelector(".js-login-password").value;console.log(n),h(a,n,t).then(o=>{window.location.href=m,i.reset()}).catch(o=>{console.error("Error signing in:",o),l.error("Не вдалося увійти. Перевірте свій email або пароль і спробуйте ще раз.")})}),S(i),d(i)}function x(){return`
        <div class="sign-in__form-input-box">
          <input
            type="text"
